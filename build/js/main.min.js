...
var addSlider = function addSlider() {
  ...
  var gap = Number(window.getComputedStyle(list).gap.replace('px', ''));
  ...
  var itemWidth = (trainersWrapper.offsetWidth - (slidesToShow - 1) * gap) / slidesToShow;
  var movePosition = slidesToScroll * (itemWidth + gap);
  ...
  items.forEach(function (element) {
    element.style.minWidth = "".concat(itemWidth, "px");
  });
  ...
  var setPosition = function setPosition() {
    list.style.transform = "translateX(".concat(position, "px)");
  };
