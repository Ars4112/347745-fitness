...
var subscriptionButton = document.querySelectorAll('.subscription__button');
var subscriptionList = document.querySelectorAll('.subscription__price-list');
...
var addTabs = function addTabs() {
  subscriptionButton.forEach(function (element) {
    element.addEventListener('click', function (evt) {
      evt.preventDefault();
      var id = element.getAttribute('href').replace('#', '');
      var subscriptionListId = document.getElementById(id);
      subscriptionButton.forEach(function (item) {
...
var addSlider = function addSlider() {
  var trainersWrapper = document.querySelector('.trainers__wrapper');
  if (trainersWrapper) {
    var list = trainersWrapper.querySelector('.trainers__list');
    var items = list.querySelectorAll('.trainers__item');
    var sliderButton = document.querySelectorAll('.trainers__button');
    var buttonLeft = document.querySelector('.trainers__button--left');
    var buttonRight = document.querySelector('.trainers__button--right');
    ...
    sliderButton.forEach(function (element) {
    ...
    // eslint-disable-next-line
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.trainers__wrapper', {
...
var addCarousel = function addCarousel() {
  ...
  if (reviewsWrapper) {
    ...
    var sliderButton = document.querySelectorAll('.reviews__button');
    var buttonLeft = reviewsWrapper.querySelector('.reviews__button--left');
    var buttonRight = reviewsWrapper.querySelector('.reviews__button--right');
    sliderButton.forEach(function (element) {
    ...
    // eslint-disable-next-line
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.reviews__wrapper', {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_1__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_1__["Pagination"]],
      navigation: {
...
var addVideo = function addVideo() {
  var videoButton = document.querySelector('.gym__play-button');
  var videoImageOverlay = document.querySelector('.gym__image-overlay');
  var videoOverlay = document.querySelector('.gym__vidio-overlay');
  var playVidio = function playVidio(evt) {
    evt.preventDefault();
    videoButton.remove();
    videoImageOverlay.remove();
    videoOverlay.remove();
    document.querySelector('.gym__frame').src = document.querySelector('.gym__frame').src + '?autoplay=1';
    // const src = document.querySelector('.gym__frame').src;
    // src.src + '?autoplay=1';

    console.log(document.querySelector('.gym__frame').src);
  };
  if (videoButton) {
